...
module TOP_tb;
	...
	initial begin
		$readmemb("../cpp/rd_addr1.mem", rd_addr1_mem);
		$readmemb("../cpp/rd_addr2.mem", rd_addr2_mem);
		$readmemb("../cpp/wr_addr.mem", wr_addr_mem);
		$readmemb("../cpp/shamt.mem", shamt_mem);
		$readmemb("../cpp/funct.mem", funct_mem);
		$readmemb("../cpp/regwr.mem", RegWrite_mem);
		$readmemh("../cpp/rd_data1.mem", rd_data1_mem);
		$readmemh("../cpp/rd_data2.mem", rd_data2_mem);
		$readmemh("../cpp/wr_data.mem", wr_data_mem);
	end
